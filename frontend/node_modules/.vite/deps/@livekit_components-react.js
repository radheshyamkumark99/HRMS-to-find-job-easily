...
function he(e3) {
  return ["top", "bottom"].includes(ae(e3)) ? "y" : "x";
}
function Gt(e3) {
  return qt(he(e3));
}
...
function it(e3) {
  return e3.replace(/start|end/g, (t) => qn[t]);
}
function Qn(e3, t, n) {
...
function Jn(e3, t, n, r2) {
  const i2 = ze(e3);
  let o = Qn(ae(e3), n === "start", r2);
  return i2 && (o = o.map((s) => s + "-" + i2), t && (o = o.concat(o.map(it)))), o;
}
function Ne(e3) {
  return e3.replace(/left|right|bottom|top/g, (t) => Yn[t]);
}
function Xn(e3) {
  return {
    top: 0,
...
function Ct(e3, t, n) {
  ...
  const o = he(t), s = Gt(t), a = Kt(s), c = ae(t), u = o === "y", l = r2.x + r2.width / 2 - i2.width / 2, f = r2.y + r2.height / 2 - i2.height / 2, h = r2[a] / 2 - i2[a] / 2;
  let d;
  switch (c) {
    case "top":
      d = {
...
var er = async (e3, t, n) => {
  ...
  for (let p = 0; p < a.length; p++) {
    ...
    }, g && m <= 50 && (m++, typeof g == "object" && (g.placement && (h = g.placement), g.rects && (u = g.rects === true ? await s.getElementRects({
      reference: e3,
      floating: t,
      strategy: i2
    }) : g.rects), {
...
async function Qt(e3, t) {
  ...
  const {
    ...
    altBoundary: h = false,
    padding: d = 0
  } = He(t, e3), m = Zn(d), b2 = a[h ? f === "floating" ? "reference" : "floating" : f], v = Fe(await o.getClippingRect({
    element: (n = await (o.isElement == null ? void 0 : o.isElement(b2))) == null || n ? b2 : b2.contextElement || await (o.getDocumentElement == null ? void 0 : o.getDocumentElement(a.floating)),
    boundary: u,
    rootBoundary: l,
    strategy: c
  })), x = f === "floating" ? {
  ...
  return e3 === void 0 && (e3 = {}), {
    ...
    async fn(t) {
      ...
      if ((n = o.arrow) != null && n.alignmentOffset)
        return {};
      const v = ae(i2), x = he(a), E = ae(a) === a, P = await (c.isRTL == null ? void 0 : c.isRTL(u.floating)), g = h || (E || !p ? [Ne(a)] : Gn(a)), S = m !== "none";
      !h && S && g.push(...Jn(a, p, m, P));
      const C = [a, ...g], $ = await Qt(t, b2), I2 = [];
      ...
      if (z2 = [...z2, {
        ...
        var T2, L3;
        const K2 = (((T2 = o.flip) == null ? void 0 : T2.index) || 0) + 1, ke = C[K2];
        if (ke)
          return {
            data: {
              index: K2,
        ...
        let xe2 = (L3 = z2.filter((fe2) => fe2.overflows[0] <= 0).sort((fe2, te2) => fe2.overflows[1] - te2.overflows[1])[0]) == null ? void 0 : L3.placement;
        if (!xe2)
          switch (d) {
            case "bestFit": {
              var oe2;
              const fe2 = (oe2 = z2.filter((te2) => {
                if (S) {
                  const ne2 = he(te2.placement);
                  return ne2 === x || // Create a bias to the `y` side axis due to horizontal
                  // reading directions favoring greater width.
                  ne2 === "y";
                }
                return true;
              }).map((te2) => [te2.placement, te2.overflows.filter((ne2) => ne2 > 0).reduce((ne2, Bn) => ne2 + Bn, 0)]).sort((te2, ne2) => te2[1] - ne2[1])[0]) == null ? void 0 : oe2[0];
              fe2 && (xe2 = fe2);
              break;
            }
...
async function nr(e3, t) {
  const {
    placement: n,
    platform: r2,
    elements: i2
  } = e3, o = await (r2.isRTL == null ? void 0 : r2.isRTL(i2.floating)), s = ae(n), a = ze(n), c = he(n) === "y", u = ["left", "top"].includes(s) ? -1 : 1, l = o && c ? -1 : 1, f = He(t, e3);
  let {
    mainAxis: h,
    crossAxis: d,
    alignmentAxis: m
  ...
  return e3 === void 0 && (e3 = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: r2
      }, l = await Qt(t, c), f = he(ae(i2)), h = qt(f);
      let d = u[h], m = u[f];
      if (o) {
        const b2 = h === "y" ? "top" : "left", v = h === "y" ? "bottom" : "right", x = d + l[b2], E = d - l[v];
        d = Tt(x, d, E);
      }
      if (s) {
        const b2 = f === "y" ? "top" : "left", v = f === "y" ? "bottom" : "right", x = m + l[b2], E = m - l[v];
        m = Tt(x, m, E);
      }
      const p = a.fn({
        ...t,
...
function or(e3) {
  return ["table", "td", "th"].includes(ge(e3));
}
function qe(e3) {
...
function ve(e3) {
  return ["html", "body", "#document"].includes(ge(e3));
}
function q(e3) {
...
function Xt(e3) {
  const t = ie(e3);
  return ve(t) ? e3.ownerDocument ? e3.ownerDocument.body : e3.body : Q(t) && Oe(t) ? t : Xt(t);
}
function Te(e3, t, n) {
  var r2;
  t === void 0 && (t = []), n === void 0 && (n = true);
  const i2 = Xt(e3), o = i2 === ((r2 = e3.ownerDocument) == null ? void 0 : r2.body), s = j(i2);
  if (o) {
    const a = ot(s);
    return t.concat(s, s.visualViewport || [], Oe(i2) ? i2 : [], a && n ? Te(a) : []);
  }
  return t.concat(i2, Te(i2, [], n));
}
function ot(e3) {
...
function Zt(e3) {
  ...
  const i2 = Q(e3), o = i2 ? e3.offsetWidth : n, s = i2 ? e3.offsetHeight : r2, a = $e(n) !== o || $e(r2) !== s;
  return a && (n = o, r2 = s), {
    width: n,
    height: r2,
    $: a
...
function pt(e3) {
  return Y(e3) ? e3 : e3.contextElement;
}
function de(e3) {
  const t = pt(e3);
  if (!Q(t))
...
function ce(e3, t, n, r2) {
  t === void 0 && (t = false), n === void 0 && (n = false);
  const i2 = e3.getBoundingClientRect(), o = pt(e3);
  let s = G(1);
  t && (r2 ? Y(r2) && (s = de(r2)) : s = de(e3));
  const a = cr(o, n, r2) ? en(o) : G(0);
  let c = (i2.left + a.x) / s.x, u = (i2.top + a.y) / s.y, l = i2.width / s.x, f = i2.height / s.y;
  if (o) {
    const h = j(o), d = r2 && Y(r2) ? j(r2) : r2;
    let m = h, p = ot(m);
    for (; p && r2 && d !== m; ) {
      const b2 = de(p), v = p.getBoundingClientRect(), x = q(p), E = v.left + (p.clientLeft + parseFloat(x.paddingLeft)) * b2.x, P = v.top + (p.clientTop + parseFloat(x.paddingTop)) * b2.y;
      c *= b2.x, u *= b2.y, l *= b2.x, f *= b2.y, c += E, u += P, m = j(p), p = ot(m);
    }
  }
  return Fe({
    width: l,
...
function ht(e3, t) {
  ...
  return t ? t.left + n : ce(X(e3)).left + n;
}
function tn(e3, t, n) {
  n === void 0 && (n = false);
...
function ur(e3) {
  ...
  const l = G(0), f = Q(r2);
  if ((f || !f && !o) && ((ge(r2) !== "body" || Oe(s)) && (c = Ke(r2)), Q(r2))) {
    const d = ce(r2);
    u = de(r2), l.x = d.x + r2.clientLeft, l.y = d.y + r2.clientTop;
  }
  const h = s && !f && !o ? tn(s, c, true) : G(0);
  return {
    width: n.width * u.x,
    height: n.height * u.y,
...
function fr(e3) {
  const t = X(e3), n = Ke(e3), r2 = e3.ownerDocument.body, i2 = se(t.scrollWidth, t.clientWidth, r2.scrollWidth, r2.clientWidth), o = se(t.scrollHeight, t.clientHeight, r2.scrollHeight, r2.clientHeight);
  let s = -n.scrollLeft + ht(e3);
  const a = -n.scrollTop;
...
function dr(e3, t) {
  const n = j(e3), r2 = X(e3), i2 = n.visualViewport;
...
function pr(e3, t) {
  const n = ce(e3, true, t === "fixed"), r2 = n.top + e3.clientTop, i2 = n.left + e3.clientLeft, o = Q(e3) ? de(e3) : G(1), s = e3.clientWidth * o.x, a = e3.clientHeight * o.y, c = i2 * o.x, u = r2 * o.y;
  return {
    width: s,
    height: a,
    x: c,
...
function hr(e3, t) {
  ...
  if (n)
    return n;
  let r2 = Te(e3, [], false).filter((a) => Y(a) && ge(a) !== "body"), i2 = null;
  const o = q(e3).position === "fixed";
  let s = o ? ie(e3) : e3;
  for (; Y(s) && !ve(s); ) {
    const a = q(s), c = ft(s);
    !c && a.position === "fixed" && (i2 = null), (o ? !c && !i2 : !c && a.position === "static" && !!i2 && ["absolute", "fixed"].includes(i2.position) || Oe(s) && !c && nn(e3, s)) ? r2 = r2.filter((l) => l !== s) : i2 = a, s = ie(s);
  }
...
function br(e3, t, n) {
  const r2 = Q(t), i2 = X(t), o = n === "fixed", s = ce(e3, true, o, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
  const c = G(0);
  if (r2 || !r2 && !o)
    if ((ge(t) !== "body" || Oe(i2)) && (a = Ke(t)), r2) {
      const h = ce(t, true, o, t);
...
function Xe(e3) {
  return q(e3).position === "static";
}
function At(e3, t) {
  if (!Q(e3) || q(e3).position === "fixed")
    return null;
  if (t)
    return t(e3);
...
function rn(e3, t) {
  ...
  for (; r2 && or(r2) && Xe(r2); )
    r2 = At(r2, t);
  return r2 && ve(r2) && Xe(r2) && !ft(r2) ? n : r2 || sr(e3) || n;
}
var gr = async function(e3) {
  const t = this.getOffsetParent || rn, n = this.getDimensions, r2 = await n(e3.floating);
  return {
    reference: br(e3.reference, await t(e3.floating), e3.strategy),
    floating: {
      x: 0,
      y: 0,
      width: r2.width,
...
function xr(e3, t) {
  ...
  function s(a, c) {
    ...
    if (a || t(), !h || !d)
      return;
    const m = Le(f), p = Le(i2.clientWidth - (l + h)), b2 = Le(i2.clientHeight - (f + d)), v = Le(l), E = {
      rootMargin: -m + "px " + -p + "px " + -b2 + "px " + -v + "px",
    ...
    function g(S) {
      ...
      C === 1 && !on(u, e3.getBoundingClientRect()) && s(), P = false;
    }
    try {
...
function Sr(e3, t, n, r2) {
  ...
  } = r2, u = pt(e3), l = i2 || o ? [...u ? Te(u) : [], ...Te(t)] : [];
  l.forEach((v) => {
    i2 && v.addEventListener("scroll", n, {
      passive: true
  ...
  let m, p = c ? ce(e3) : null;
  c && b2();
  function b2() {
    const v = ce(e3);
    p && !on(p, v) && n(), p = v, m = requestAnimationFrame(b2);
  }
  return n(), () => {
    var v;
    l.forEach((x) => {
...
function kr() {
  return kt || (kt = 1, function(e3) {
    (function(t, n) {
      ...
      function l() {
        for (var p = this.getLevel(), b2 = 0; b2 < i2.length; b2++) {
          var v = i2[b2];
          this[v] = b2 < p ? t : this.methodFactory(v, p, this.name);
        }
      ...
      function d(p, b2) {
        ...
        function S(T2) {
          var L3 = (i2[T2] || "silent").toUpperCase();
          if (!(typeof window === n || !g)) {
            try {
              window.localStorage[g] = L3;
              return;
            } catch {
            }
            try {
              window.document.cookie = encodeURIComponent(g) + "=" + L3 + ";";
            } catch {
            }
          }
        }
        function C() {
          ...
          if (!(typeof window === n || !g)) {
            try {
              T2 = window.localStorage[g];
            } catch {
            }
            if (typeof T2 === n)
              try {
                var L3 = window.document.cookie, oe2 = encodeURIComponent(g), K2 = L3.indexOf(oe2 + "=");
                K2 !== -1 && (T2 = /^([^;]+)/.exec(
                  L3.slice(K2 + oe2.length + 1)
                )[1]);
              } catch {
              }
            return v.levels[T2] === void 0 && (T2 = void 0), T2;
          }
        }
        function $() {
          if (!(typeof window === n || !g)) {
        ...
        function I2(T2) {
          var L3 = T2;
          if (typeof L3 == "string" && v.levels[L3.toUpperCase()] !== void 0 && (L3 = v.levels[L3.toUpperCase()]), typeof L3 == "number" && L3 >= 0 && L3 <= v.levels.SILENT)
            return L3;
        ...
        v.name = p, v.levels = {
          ...
          ERROR: 4,
          SILENT: 5
        }, v.methodFactory = b2 || h, v.getLevel = function() {
          return P ?? E ?? x;
        }, v.setLevel = function(T2, L3) {
          return P = I2(T2), L3 !== false && S(P), l.call(v);
        }, v.setDefaultLevel = function(T2) {
          E = I2(T2), C() || v.setLevel(T2, false);
        }, v.resetLevel = function() {
          P = null, $(), l.call(v);
        }, v.enableAll = function(T2) {
          v.setLevel(v.levels.TRACE, T2);
        }, v.disableAll = function(T2) {
          v.setLevel(v.levels.SILENT, T2);
        }, v.rebuild = function() {
          if (s !== v && (x = I2(s.getLevel())), l.call(v), s === v)
            for (var T2 in o)
              o[T2].rebuild();
        }, x = I2(
          s ? s.getLevel() : "WARN"
        ...
        var z2 = C();
        z2 != null && (P = I2(z2)), l.call(v);
      }
      s = new d(), s.getLogger = function(b2) {
        if (typeof b2 != "symbol" && typeof b2 != "string" || b2 === "")
          throw new TypeError("You must supply a name when creating a logger.");
        var v = o[b2];
        return v || (v = o[b2] = new d(
          b2,
          s.methodFactory
        )), v;
      };
...
function pe(e3) {
  return this instanceof pe ? (this.v = e3, this) : new pe(e3);
}
function Mr(e3, t, n) {
  ...
  function a(d, m) {
    r2[d] && (i2[d] = function(p) {
      return new Promise(function(b2, v) {
        o.push([d, p, b2, v]) > 1 || c(d, p);
      });
    }, m && (i2[d] = m(i2[d])));
  }
  function c(d, m) {
...
function Rr(e3) {
  ...
  return t ? t.call(e3) : (e3 = typeof me == "function" ? me(e3) : e3[Symbol.iterator](), n = {}, r2("next"), r2("throw"), r2("return"), n[Symbol.asyncIterator] = function() {
    return this;
  }, n);
  function r2(o) {
    n[o] = e3[o] && function(s) {
    ...
    if (!this.closed) {
      ...
      if (f) {
        ...
        try {
          ...
          try {
            d && !d.done && (i2 = h.return) && i2.call(h);
          } finally {
...
var an = Ae.EMPTY;
function cn(e3) {
  return e3 instanceof Ae || e3 && "closed" in e3 && O(e3.remove) && O(e3.add) && O(e3.unsubscribe);
}
function Lt(e3) {
...
var $r = {
  setTimeout: function(e3, t) {
    for (var n = [], r2 = 2; r2 < arguments.length; r2++)
      n[r2 - 2] = arguments[r2];
    return setTimeout.apply(void 0, be([e3, t], ue(n)));
  },
...
function jr(e3) {
  return e3.length === 0 ? gt : e3.length === 1 ? e3[0] : function(n) {
...
function Br(e3) {
  return e3 && e3 instanceof mt || Wr(e3) && cn(e3);
}
function Vr(e3) {
...
function B(e3, t, n, r2, i2) {
  return new Hr(e3, t, n, r2, i2);
}
var Hr = function(e3) {
  ee(t, e3);
...
var Mt = {
  setInterval: function(e3, t) {
    for (var n = [], r2 = 2; r2 < arguments.length; r2++)
      n[r2 - 2] = arguments[r2];
    return setInterval.apply(void 0, be([e3, t], ue(n)));
  },
...
function ri(e3) {
  return new k(function(t) {
    var n, r2;
    try {
      for (var i2 = me(e3), o = i2.next(); !o.done; o = i2.next()) {
        var s = o.value;
...
function oi(e3, t) {
  ...
  return Ir(this, void 0, void 0, function() {
    ...
    return sn(this, function(c) {
      switch (c.label) {
        case 0:
          c.trys.push([0, 5, 6, 11]), n = Rr(e3), c.label = 1;
        case 1:
          return [4, n.next()];
        case 2:
...
function wn(e3, t) {
  return t === void 0 && (t = 0), U(function(n, r2) {
    n.subscribe(B(r2, function(i2) {
      return re(r2, e3, function() {
        return r2.next(i2);
      }, t);
    }, function() {
      return re(r2, e3, function() {
...
function ui(e3, t) {
  return new k(function(n) {
    ...
    return re(n, t, function() {
      ...
      return O(r2 == null ? void 0 : r2.return) && r2.return();
    };
  });
}
function Sn(e3, t) {
...
var pi = vt(function(e3) {
  return function(n) {
    n === void 0 && (n = null), e3(this), this.message = "Timeout has occurred", this.name = "TimeoutError", this.info = n;
  };
});
function hi(e3, t) {
  var n = di(e3) ? { first: e3 } : typeof e3 == "number" ? { each: e3 } : e3, r2 = n.first, i2 = n.each, o = n.with, s = o === void 0 ? vi : o, a = n.scheduler, c = a === void 0 ? Qr : a, u = n.meta, l = u === void 0 ? null : u;
  if (r2 == null && i2 == null)
    throw new TypeError("No timeout provided.");
  return U(function(f, h) {
    var d, m, p = null, b2 = 0, v = function(x) {
      m = re(h, c, function() {
        try {
          d.unsubscribe(), H(s({
            meta: l,
    ...
    d = f.subscribe(B(h, function(x) {
      m == null || m.unsubscribe(), b2++, h.next(p = x), i2 > 0 && v(i2);
    }, void 0, void 0, function() {
      m != null && m.closed || m == null || m.unsubscribe(), p = null;
    })), !b2 && v(r2 != null ? typeof r2 == "number" ? r2 : +r2 - c.now() : i2);
  });
}
function vi(e3) {
  throw new pi(e3);
...
function A(e3, t) {
  return U(function(n, r2) {
    var i2 = 0;
    n.subscribe(B(r2, function(o) {
...
function bi(e3, t) {
  return mi(t) ? e3.apply(void 0, be([], ue(t))) : e3(t);
}
function gi(e3) {
  return A(function(t) {
    return bi(e3, t);
...
function yi(e3, t, n, r2, i2, o, s, a) {
  var c = [], u = 0, l = 0, f = false, h = function() {
  ...
  return e3.subscribe(B(t, d, function() {
    f = true, h();
  })), function() {
  };
}
function xt(e3, t, n) {
  return n === void 0 && (n = 1 / 0), O(t) ? xt(function(r2, i2) {
    return A(function(o, s) {
      return t(r2, o, i2, s);
    })(H(e3(r2, i2)));
  }, n) : (typeof t == "number" && (n = t), U(function(r2, i2) {
    return yi(r2, i2, e3, n);
  }));
}
function wi(e3) {
  return xt(gt, e3);
...
function We() {
  for (var e3 = [], t = 0; t < arguments.length; t++)
    e3[t] = arguments[t];
  return xi()(Ge(e3, yt(e3)));
}
var Si = ["addListener", "removeListener"];
var Ei = ["addEventListener", "removeEventListener"];
var Ti = ["on", "off"];
function at(e3, t, n, r2) {
  if (O(n) && (r2 = n, n = void 0), r2)
    return at(e3, t, n).pipe(gi(r2));
  var i2 = ue(Oi(e3) ? Ei.map(function(a) {
    return function(c) {
      return e3[a](t, c, n);
    };
  }) : Ci(e3) ? Si.map($t(e3, t)) : Pi(e3) ? Ti.map($t(e3, t)) : [], 2), o = i2[0], s = i2[1];
  if (!o && wt(e3))
...
function ki(e3, t) {
  return t === void 0 && (t = gt), e3 = e3 ?? Li, U(function(n, r2) {
    var i2, o = true;
    n.subscribe(B(r2, function(s) {
      var a = t(s);
...
function ct(e3, t) {
  return U(Ai(e3, t, arguments.length >= 2, true));
}
function Ii(e3) {
  e3 === void 0 && (e3 = {});
  ...
  return function(u) {
    var l, f, h, d = 0, m = false, p = false, b2 = function() {
      f == null || f.unsubscribe(), f = void 0;
    }, v = function() {
      b2(), l = h = void 0, m = p = false;
    }, x = function() {
      var E = l;
    ...
    return U(function(E, P) {
      ...
      P.add(function() {
        ...
        error: function(S) {
          p = true, b2(), f = et(v, i2, S), g.error(S);
        },
        complete: function() {
          m = true, b2(), f = et(v, s), g.complete();
        }
      }), H(E).subscribe(l));
    })(u);
  };
...
function et(e3, t) {
  ...
  if (t !== false) {
    ...
    return H(t.apply(void 0, be([], ue(n)))).subscribe(i2);
  }
}
function Mi(e3) {
  return U(function(t, n) {
    var r2 = false, i2 = B(n, function() {
      i2 == null || i2.unsubscribe(), r2 = true;
    }, je);
    H(e3).subscribe(i2), t.subscribe(B(n, function(o) {
      return r2 && n.next(o);
    }));
  });
}
...
function En(e3, t) {
  return U(function(n, r2) {
    ...
    n.subscribe(B(r2, function(c) {
      i2 == null || i2.unsubscribe();
      var u = 0, l = o++;
      H(e3(c, l)).subscribe(i2 = B(r2, function(f) {
...
var Ut = (e3, t, n) => t in e3 ? Ri(e3, t, { enumerable: true, configurable: true, writable: true, value: n }) : e3[t] = n;
var Z = (e3, t) => {
  for (var n in t || (t = {}))
    Ni.call(t, n) && Ut(e3, n, t[n]);
  if (Ft)
    for (var n of Ft(t))
      Fi.call(t, n) && Ut(e3, n, t[n]);
  return e3;
};
var Ee = (e3, t) => Di(e3, $i(t));
...
var Tn = "lk";
function W(e3) {
  return typeof e3 > "u" ? false : Ui(e3) || ji(e3);
}
function Ui(e3) {
  var t;
...
function $o(e3, t) {
  return e3 === void 0 || t === void 0 ? false : W(e3) && W(t) ? e3.publication.trackSid === t.publication.trackSid : N(e3) === N(t);
}
function No(e3, t) {
  return typeof t > "u" ? false : W(e3) ? t.some(
    (n) => n.participant.identity === e3.participant.identity && W(n) && n.publication.trackSid === e3.publication.trackSid
  ) : Pe(e3) ? t.some(
    (n) => n.participant.identity === e3.participant.identity && Pe(n) && n.source === e3.source
  ) : false;
}
function Wi(e3, t) {
  return Pe(e3) && W(t) && t.participant.identity === e3.participant.identity && t.source === e3.source;
}
function Fo() {
...
var jt = "[^\\.\\s@:](?:[^\\s@:]*[^\\s@:\\.])?@[^\\.\\s@]+(?:\\.[^\\.\\s@]+)*";
function Vi({ exact: e3 } = {}) {
  return e3 ? new RegExp(`^${jt}$`) : new RegExp(jt, "g");
}
function jo(e3, t, n) {
  return Sr(e3, t, () => V(this, null, function* () {
    const { x: i2, y: o } = yield Pr(e3, t, {
      placement: "top",
...
var _2 = _r.getLogger("lk-components-js");
_2.setDefaultLevel("WARN");
function Ho(e3, t = {}) {
  var n;
  _2.setLevel(e3), setLogLevel((n = t.liveKitClientLogLevel) != null ? n : e3);
}
function zo(e3, t = {}) {
  var n;
  const r2 = _2.methodFactory;
  _2.methodFactory = (i2, o, s) => {
    const a = r2(i2, o, s), c = LogLevel[i2], u = c >= o && c < LogLevel.silent;
    return (l, f) => {
      f ? a(l, f) : a(l), u && e3(c, l, f);
    };
  }, _2.setLevel(_2.getLevel()), setLogExtension((n = t.liveKitClientLogExtension) != null ? n : e3);
}
var Yo = [
  {
    columns: 1,
...
function qi(e3, t, n, r2) {
  ...
  let a = i2.find((c, u, l) => {
    ...
    const f = l.findIndex((h, d) => {
      const m = !h.orientation || h.orientation === s, p = d > u, b2 = h.maxTiles === c.maxTiles;
      return p && b2 && m;
    }) !== -1;
...
function Qo(e3) {
  return Array.isArray(e3) && e3.filter(Gi).length > 0;
}
function kn(e3, t) {
...
function Zi(e3) {
  ...
  }), n.sort((r2, i2) => r2.participant.isSpeaking && i2.participant.isSpeaking ? kn(r2.participant, i2.participant) : r2.participant.isSpeaking !== i2.participant.isSpeaking ? Ln(r2.participant, i2.participant) : r2.participant.lastSpokeAt !== i2.participant.lastSpokeAt ? _n(r2.participant, i2.participant) : W(r2) !== W(i2) ? Qi(r2, i2) : r2.participant.isCameraEnabled !== i2.participant.isCameraEnabled ? Ji(r2, i2) : Be(r2.participant, i2.participant)), [...t, ...n];
}
function Xo(e3) {
  const t = [...e3];
  t.sort((r2, i2) => {
  ...
  return e3.map((n) => {
    const r2 = t.find(
      (i2) => (
        ...
        typeof n != "number" && Pe(n) && W(i2) && Wi(n, i2)
      )
    );
    return r2 ?? n;
  });
...
function ts(e3) {
  return ye(e3, RoomEvent.ConnectionStateChanged).pipe(
    A(([t]) => t),
    D(e3.state)
  );
}
...
function rs(e3) {
  return ye(e3, RoomEvent.ActiveSpeakersChanged).pipe(
    A(([t]) => t)
  );
}
function is(e3, t, n = true) {
  var r2;
  const i2 = () => V(this, null, function* () {
    try {
      const a = yield Room.getLocalDevices(e3, n);
      o.next(a);
    } catch (a) {
      t == null || t(a);
    }
    ...
    _i(() => {
      var a;
      (a = navigator == null ? void 0 : navigator.mediaDevices) == null || a.removeEventListener("devicechange", i2);
    })
  );
  if (typeof window < "u") {
    ...
    (r2 = navigator == null ? void 0 : navigator.mediaDevices) == null || r2.addEventListener("devicechange", i2);
  }
  return We(
    Room.getLocalDevices(e3, n).catch((a) => (t == null || t(a), [])),
    s
  );
}
function ao(e3) {
  return ye(e3, RoomEvent.DataReceived);
}
function co(e3) {
  return le(e3, RoomEvent.AudioPlaybackStatusChanged).pipe(
    A((n) => ({ canPlayAudio: n.canPlaybackAudio }))
  );
}
function uo(e3) {
  return le(e3, RoomEvent.VideoPlaybackStatusChanged).pipe(
    A((n) => ({ canPlayVideo: n.canPlaybackVideo }))
  );
}
function lo(e3, t) {
  return ye(e3, RoomEvent.ActiveDeviceChanged).pipe(
    Qe(([n]) => n === t),
    A(([n, r2]) => (_2.debug("activeDeviceObservable | RoomEvent.ActiveDeviceChanged", { kind: n, deviceId: r2 }), r2))
  );
}
function os(e3, t) {
  return ye(e3, RoomEvent.ParticipantEncryptionStatusChanged).pipe(
    Qe(
...
function ss(e3) {
  return ye(e3, RoomEvent.RecordingStatusChanged).pipe(
    A(([t]) => t),
    D(e3.isRecording)
  );
}
...
function as(e3) {
  return Je(e3, ParticipantEvent.IsSpeakingChanged).pipe(
    A(([t]) => t)
  );
}
function cs(e3, t = {}) {
...
function fs(e3, { kind: t, identity: n }, r2 = {}) {
  var i2;
...
function ds(e3) {
  return typeof e3 > "u" ? new k() : Je(e3, ParticipantEvent.AttributesChanged).pipe(
    A(([t]) => ({
      changed: t,
...
function hs() {
  let e3 = false;
  const t = new J(), n = new J(), r2 = (o) => V(this, null, function* () {
...
function vs(e3, t, n) {
  const r2 = new ln(void 0), i2 = lo(t, e3), o = (a, ...c) => V(this, [a, ...c], function* (u, l = {}) {
    var f, h, d;
    if (t) {
      _2.debug(`Switching active device of kind "${e3}" with id ${u}.`), yield t.switchActiveDevice(e3, u, l.exact);
      const m = (f = t.getActiveDevice(e3)) != null ? f : u;
      m !== u && u !== "default" && _2.info(
        `We tried to select the device with id (${u}), but the browser decided to select the device with id (${m}) instead.`
      );
      let p;
      e3 === "audioinput" ? p = (h = t.localParticipant.getTrackPublication(Track.Source.Microphone)) == null ? void 0 : h.track : e3 === "videoinput" && (p = (d = t.localParticipant.getTrackPublication(Track.Source.Camera)) == null ? void 0 : d.track);
      const b2 = u === "default" && !p || u === "default" && (p == null ? void 0 : p.mediaStreamTrack.label.startsWith("Default"));
      r2.next(b2 ? u : m);
    }
  });
  return {
...
function bs(e3) {
  const t = F("connection-quality"), n = po(e3);
...
function gs(e3) {
  ...
  const n = F(t), r2 = ho(e3);
  return { className: n, mediaMutedObserver: r2 };
}
function ys(e3) {
  return { className: "lk-participant-name", infoObserver: fo(e3) };
}
function ws() {
  return {
...
function bo(e3, t, n) {
  const r2 = Array.isArray(t) ? t : [t], i2 = ao(e3).pipe(
    Qe(
  ...
  return { messageObservable: i2, isSendingObservable: s, send: (c, ...u) => V(this, [c, ...u], function* (l, f = {}) {
    o.next(true);
    try {
      yield Mn(e3.localParticipant, l, Z({ topic: r2[0] }, f));
    } finally {
      o.next(false);
    }
  }) };
...
var yo = (e3) => JSON.parse(new TextDecoder().decode(e3));
var wo = (e3) => new TextEncoder().encode(JSON.stringify(e3));
function xs(e3, t) {
  var n, r2, i2, o, s, a;
  const c = () => {
    var g, S, C;
    return ((g = e3.serverInfo) == null ? void 0 : g.edition) === 1 || !!((S = e3.serverInfo) != null && S.version) && compareVersions((C = e3.serverInfo) == null ? void 0 : C.version, "1.8.2") > 0;
  }, u = new J(), l = (n = t == null ? void 0 : t.channelTopic) != null ? n : vo.CHAT, f = (r2 = t == null ? void 0 : t.channelTopic) != null ? r2 : mo.CHAT;
  let h = false;
  Ie.has(e3) || (h = true);
  const d = (i2 = Ie.get(e3)) != null ? i2 : /* @__PURE__ */ new Map(), m = (o = d.get(l)) != null ? o : new J();
  ...
  if (h) {
    ...
    const { messageObservable: g } = bo(e3, [f]);
    g.pipe(
      A((S) => {
        const C = p(S.payload);
  ...
  const b2 = m.pipe(
    ct((g, S) => {
      if ("id" in S && g.find((C) => {
        var $, I2;
        return (($ = C.from) == null ? void 0 : $.identity) === ((I2 = S.from) == null ? void 0 : I2.identity) && C.id === S.id;
      })) {
    ...
    Nt(u)
  ), v = new ln(false), x = (a = t == null ? void 0 : t.messageEncoder) != null ? a : wo, E = (g, S) => V(this, null, function* () {
    var C;
    S || (S = {}), (C = S.topic) != null || (S.topic = l), v.next(true);
    try {
      const I2 = {
        id: (yield e3.localParticipant.sendText(g, S)).id,
        timestamp: Date.now(),
        message: g,
      ...
      return yield Mn(e3.localParticipant, z2, {
        reliable: true,
        topic: f
      }), I2;
    } finally {
  ...
  return e3.once(RoomEvent.Disconnected, P), {
    messageObservable: b2,
...
function Ss() {
  const e3 = (n) => V(this, null, function* () {
    _2.info("Start Audio for room: ", n), yield n.startAudio();
  });
  return { className: F("start-audio-button"), roomAudioPlaybackAllowedObservable: co, handleStartAudioPlayback: e3 };
}
function Es() {
  const e3 = (n) => V(this, null, function* () {
    _2.info("Start Video for room: ", n), yield n.startVideo();
  });
  return { className: F("start-audio-button"), roomVideoPlaybackAllowedObservable: uo, handleStartVideoPlayback: e3 };
}
function Ts() {
...
function As(e3, t, n) {
  ...
  return le(e3, ...a).pipe(
    A((u) => {
      const l = Vt(u, t, s);
      return _2.debug(`TrackReference[] was updated. (length ${l.trackReferences.length})`, l), l;
    }),
    D(Vt(e3, t, s))
  );
}
function ks(e3, t) {
  return we(e3, ...zi).pipe(
    A((r2) => {
      const i2 = Ht(r2, t);
      return _2.debug(`TrackReference[] was updated. (length ${i2.length})`, i2), i2;
    }),
    D(Ht(e3, t))
  );
}
...
function Is(e3, t = 1e3) {
  if (e3 === null) return Dt(false);
  const n = at(e3, "mousemove", { passive: true }).pipe(A(() => true)), r2 = n.pipe(
    hi({
      each: t,
      with: () => We(Dt(false), r2.pipe(Mi(n)))
    }),
    ki()
  );
  return r2;
...
function xo(e3, t) {
  if (typeof localStorage > "u") {
    _2.error("Local storage is not available.");
    return;
  }
  try {
    if (t) {
    ...
    _2.error(`Error setting item to local storage: ${n}`);
  }
}
function So(e3) {
  if (typeof localStorage > "u") {
  ...
  try {
    ...
    if (!t) {
      _2.warn(`Item with key ${e3} does not exist in local storage.`);
      return;
    }
    return JSON.parse(t);
  } catch (t) {
    _2.error(`Error getting item from local storage: ${t}`);
    return;
  }
}
function Eo(e3) {
...
var { load: Co, save: Po } = Eo(To);
function Ms(e3, t = false) {
  t !== true && Po(e3);
}
function Rs(e3, t = false) {
  var n, r2, i2, o, s;
  const a = {
    videoEnabled: (n = e3 == null ? void 0 : e3.videoEnabled) != null ? n : Se.videoEnabled,
    audioEnabled: (r2 = e3 == null ? void 0 : e3.audioEnabled) != null ? r2 : Se.audioEnabled,
    videoDeviceId: (i2 = e3 == null ? void 0 : e3.videoDeviceId) != null ? i2 : Se.videoDeviceId,
    audioDeviceId: (o = e3 == null ? void 0 : e3.audioDeviceId) != null ? o : Se.audioDeviceId,
    username: (s = e3 == null ? void 0 : e3.username) != null ? s : Se.username
  };
  if (t)
    return a;
  {
...
function ko(e3, t) {
  const n = Ao();
  let r2 = n.get(e3);
  return r2 || (r2 = `room_${Oo++}`, n.set(e3, r2)), `${r2}:${t}`;
}
function Ds(e3, t) {
  const n = ko(e3, t), r2 = zt(), i2 = r2.get(n);
  if (i2)
    return i2;
  const o = new J(), s = [];
  e3.registerTextStreamHandler(t, (c, u) => V(this, null, function* () {
    Ge(c).pipe(
      ct((f, h) => f + h, "")
    ).subscribe((f) => {
  ...
  return r2.set(n, a), e3.once(RoomEvent.Disconnected, () => {
...
var Nn = M.createContext(void 0);
function $s() {
  const e3 = M.useContext(Nn);
  if (!e3)
...
function Fs() {
  const [e3, t] = M.useReducer($n, On), [n, r2] = M.useReducer(Dn, An);
  return {
...
function Us(e3) {
  const [t, n] = M.useReducer($n, On), [r2, i2] = M.useReducer(Dn, An);
  return e3 ?? {
...
var Fn = M.createContext(
  void 0
);
function js() {
  const e3 = M.useContext(Fn);
  if (!e3)
...
var jn = M.createContext(void 0);
function Bs() {
  const e3 = M.useContext(jn);
  if (!e3)
...
function Vs(e3) {
  const t = _o(), n = Un(), r2 = e3 ?? t ?? (n == null ? void 0 : n.participant);
  if (!r2)
    throw new Error(
...
var Wn = M.createContext(void 0);
function Hs() {
  const e3 = M.useContext(Wn);
  if (!e3)
...
function M2(...n) {
  ...
  for (let o = 1; o < n.length; o++) {
    ...
    for (const r2 in t) {
      ...
      90 ? e3[r2] = _3(d, a) : (r2 === "className" || r2 === "UNSAFE_className") && typeof d == "string" && typeof a == "string" ? e3[r2] = A2(d, a) : e3[r2] = a !== void 0 ? a : d;
    }
  }
  return e3;
}
...
function B2(...n) {
  return M2(...n.filter(I));
}
function G2(n, e3, o) {
  return i.Children.map(n, (t) => i.isValidElement(t) && i.Children.only(n) ? (t.props.class && (e3 ?? (e3 = {}), e3.class = A2(t.props.class, e3.class), e3.style = { ...t.props.style, ...e3.style }), i.cloneElement(t, { ...e3, key: o })) : t);
}
function H2(n) {
  var e3, o;
  ...
  ((o = process == null ? void 0 : process.env) == null ? void 0 : o.NODE_ENV) === "development")) {
    ...
    t && !getComputedStyle(t).getPropertyValue("--lk-has-imported-styles") && _2.warn(
...
function q2(n) {
  ...
  const [s, O4] = i.useState(), C = i.useRef(a);
  i.useEffect(() => {
    O4(r2 ?? new Room(t));
  }, [r2, JSON.stringify(t, J2)]);
  const F2 = i.useMemo(() => {
    const { className: m } = Os();
    return M2(P, { className: m });
  }, [P]);
  return i.useEffect(() => {
    if (!s) return;
    const m = () => {
      const f = s.localParticipant;
      _2.debug("trying to publish local tracks"), Promise.all([
        ...
        _2.warn(R), c == null || c(R);
      });
    }, S = (f) => {
      const R = MediaDeviceFailure.getFailure(f);
      b2 == null || b2(R);
    }, k2 = (f) => {
      E == null || E(f);
    }, N2 = (f) => {
    ...
    return s.on(RoomEvent.SignalConnected, m).on(RoomEvent.MediaDevicesError, S).on(RoomEvent.EncryptionError, k2).on(RoomEvent.Disconnected, N2).on(RoomEvent.Connected, D3), () => {
      s.off(RoomEvent.SignalConnected, m).off(RoomEvent.MediaDevicesError, S).off(RoomEvent.EncryptionError, k2).off(RoomEvent.Disconnected, N2).off(RoomEvent.Connected, D3);
    };
  }, [
    s,
    p,
    ...
    if (s) {
      ...
      if (a) {
        if (C.current = true, _2.debug("connecting"), !e3) {
          _2.debug("no token yet");
          return;
        }
        if (!o) {
          _2.warn("no livekit url provided"), c == null || c(Error("no livekit url provided"));
          return;
        }
        s.connect(o, e3, d).catch((m) => {
          _2.warn(m), C.current === true && (c == null || c(m));
        });
      } else
        _2.debug("disconnecting because connect is false"), C.current = false, s.disconnect();
    }
  }, [
    a,
    e3,
    ...
    if (s)
      return () => {
        _2.info("disconnecting on onmount"), s.disconnect();
      };
  }, [s]), { room: s, htmlProps: F2 };
}
var Q2 = i.forwardRef(function(e3, o) {
  const { room: t, htmlProps: r2 } = q2(e3);
  return i.createElement("div", { ref: o, ...r2 }, t && i.createElement(Wn.Provider, { value: t }, i.createElement(Mo.Provider, { value: e3.featureFlags }, e3.children)));
});
...
function $e2(e3, t) {
  ...
  }, [e3.current, n, a]), n == null ? void 0 : n.observer;
}
function He2() {
  let e3 = false, t = [];
  ...
  const a = new ResizeObserver((s, c) => {
    t = t.concat(s), e3 || window.requestAnimationFrame(() => {
...
function b(e3, t, n = true) {
  const [a, s] = r.useState(t);
  return r.useEffect(() => {
    if (n && s(t), typeof window > "u" || !e3) return;
    const c = e3.subscribe(s);
    return () => c.unsubscribe();
  }, [e3, n]), a;
}
function gt2(e3) {
  const t = (c) => typeof window < "u" ? window.matchMedia(c).matches : false, [n, a] = r.useState(t(e3));
  function s() {
    a(t(e3));
  }
  return r.useEffect(() => {
...
function vt2(e3) {
  const t = zs(e3), n = r.useCallback(async () => {
    await t.startAudio();
  }, [t]), a = r.useMemo(
    () => co(t),
    [t]
...
function ht2(e3) {
  const { state: t, dispatch: n } = $s().pin;
  return { buttonProps: r.useMemo(() => {
    const { className: s } = Ps();
    return M2(e3, {
      className: s,
...
function Mt2(e3 = {}) {
  const t = Vs(e3.participant), { className: n, connectionQualityObserver: a } = r.useMemo(
    () => bs(t),
    [t]
...
function O2(e3) {
  const t = zs(e3), n = r.useMemo(() => ts(t), [t]);
  return b(n, t.state);
}
function yt2(e3, t) {
  const n = typeof e3 == "function" ? e3 : t, a = typeof e3 == "string" ? e3 : void 0, s = Hs(), { send: c, messageObservable: o, isSendingObservable: u } = r.useMemo(
    () => bo(s, a, n),
    [s, a, n]
...
function Pt2(e3) {
  const t = Hs(), n = O2(t);
  return { buttonProps: r.useMemo(() => {
    const { className: s, disconnect: c } = ms(t);
    return M2(e3, {
      className: s,
...
function kt2({ trackRef: e3, props: t }) {
  const n = Ws(e3), a = Lo(), { className: s } = r.useMemo(() => Cs(), []), c = r.useMemo(() => No(n, a == null ? void 0 : a.pin.state), [n, a == null ? void 0 : a.pin.state]);
...
function Et(e3, t, n = {}) {
  const a = n.gridLayouts ?? Yo, { width: s, height: c } = Xe2(e3), o = qi(a, t, s, c);
  return r.useEffect(() => {
...
function U2(e3, t = {}) {
  var u, i2;
  const n = typeof e3 == "string" ? t.participant : e3.participant, a = Vs(n), s = typeof e3 == "string" ? { participant: a, source: e3 } : e3, [c, o] = r.useState(
    !!((u = s.publication) != null && u.isMuted || (i2 = a.getTrackPublication(s.source)) != null && i2.isMuted)
  );
  return r.useEffect(() => {
    const d = ho(s).subscribe(o);
    return () => d.unsubscribe();
  }, [N(s)]), c;
}
function Ze2(e3) {
  const t = Vs(e3), n = r.useMemo(() => as(t), [t]);
  return b(n, t.isSpeaking);
}
function Ke2(e3 = {}) {
  const t = zs(e3.room), [n, a] = r.useState(t.localParticipant), [s, c] = r.useState(
    ...
    void 0
  ), [y, h] = r.useState(void 0), P = (M3) => {
    u(M3.isCameraEnabled), c(M3.isMicrophoneEnabled), S(M3.isScreenShareEnabled), h(M3.cameraTrack), m(M3.microphoneTrack), d(M3.participant.lastMicrophoneError), l(M3.participant.lastCameraError), a(M3.participant);
  };
  return r.useEffect(() => {
    const M3 = In(t.localParticipant).subscribe(P);
    return () => M3.unsubscribe();
  }, [t]), {
...
function Tt2() {
  const e3 = Hs(), t = r.useMemo(
    () => ls(e3.localParticipant),
    [e3]
  );
  return b(t, e3.localParticipant.permissions);
}
function wt2({
  kind: e3,
  room: t,
  ...
  const c = Io(), o = r.useMemo(() => t ?? c ?? new Room(), [t, c]), u = r.useMemo(
    () => is(e3, s, a),
    [e3, a, s]
  ), i2 = b(u, []), [d, f] = r.useState(
    (o == null ? void 0 : o.getActiveDevice(e3)) ?? "default"
  ...
  return r.useEffect(() => {
    const g = p.subscribe((m) => {
      m && (_2.info("setCurrentDeviceId", m), f(m));
    });
    return () => {
...
function et2(e3, t, n = {}) {
  const a = r.useRef([]), s = r.useRef(-1), c = t !== s.current, o = typeof n.customSortFunction == "function" ? n.customSortFunction(e3) : Jo(e3);
  let u = [...o];
  if (c === false)
    try {
      u = Zo(a.current, o, t);
    } catch (i2) {
      _2.error("Error while running updatePages(): ", i2);
    }
  return c ? a.current = o : a.current = u, s.current = t, u;
}
function Ct2(e3, t) {
  const [n, a] = r.useState(1), s = Math.max(Math.ceil(t.length / e3), 1);
  n > s && a(s);
  const c = n * e3, o = c - e3, u = (l) => {
    a((p) => l === "next" ? p === s ? p : p + 1 : p === 1 ? p : p - 1);
  }, i2 = (l) => {
    l > s ? a(s) : l < 1 ? a(1) : a(l);
  }, f = et2(t, e3).slice(o, c);
  return {
    totalPageCount: s,
    nextPage: () => u("next"),
    prevPage: () => u("previous"),
...
function Ot2(e3 = {}) {
  let t = _o();
  e3.participant && (t = e3.participant);
  const n = r.useMemo(() => fo(t), [t]), { identity: a, name: s, metadata: c } = b(n, {
...
function It2(e3 = {}) {
  const t = Vs(e3.participant), n = r.useMemo(() => ls(t), [t]);
...
function Dt2({
  ...
  const s = Ws(e3), c = r.useMemo(() => {
    const { className: p } = ws();
    return M2(a, {
      className: p,
      onClick: (S) => {
        var g;
    ...
    publication: o
  }), [o, s.participant]), i2 = U2(s), d = U2(u), f = Ze2(s.participant), l = Ye2(s);
  return {
    elementProps: {
...
function H3(e3 = {}) {
  const t = zs(e3.room), [n, a] = r.useState([]);
  return r.useEffect(() => {
    const s = cs(t, {
      additionalRoomEvents: e3.updateOnlyOn
    }).subscribe(a);
    return () => s.unsubscribe();
  }, [t, JSON.stringify(e3.updateOnlyOn)]), n;
}
function Lt2(e3 = {}) {
  const t = H3(e3), { localParticipant: n } = Ke2(e3);
  return r.useMemo(
    () => [n, ...t],
    [n, t]
  );
...
function Rt2(e3) {
  return e3 = Ns(e3), r.useMemo(() => (e3 == null ? void 0 : e3.pin.state) !== void 0 && e3.pin.state.length >= 1 ? e3.pin.state : [], [e3.pin.state]);
}
function Nt2(e3, t = {}) {
  const n = Hs(), [a] = r.useState(t.updateOnlyOn), s = r.useMemo(() => typeof e3 == "string" ? us(n, e3, {
    additionalEvents: a
  }) : fs(n, e3, {
    additionalEvents: a
  }), [n, JSON.stringify(e3), a]), [c, o] = r.useState({
    p: void 0
  });
  return r.useEffect(() => {
...
function Ft2(e3 = {}) {
  const t = zs(e3.room), n = r.useMemo(() => ns(t), [t]), { name: a, metadata: s } = b(n, {
    name: t.name,
    metadata: t.metadata
  });
...
function tt2() {
  const e3 = Hs(), t = r.useMemo(() => rs(e3), [e3]);
  return b(t, e3.activeSpeakers);
}
function Vt2(e3) {
...
function Bt2({ room: e3, props: t }) {
  const n = zs(e3), { className: a, roomAudioPlaybackAllowedObservable: s, handleStartAudioPlayback: c } = r.useMemo(
    () => Ss(),
    []
  ), o = r.useMemo(
    () => s(n),
...
function zt2({ room: e3, props: t }) {
  const n = zs(e3), { className: a, roomVideoPlaybackAllowedObservable: s, handleStartVideoPlayback: c } = r.useMemo(
    () => Es(),
    []
  ), o = r.useMemo(
    () => s(n),
...
function qt2({ props: e3 }) {
  const { dispatch: t, state: n } = $s().widget, { className: a } = r.useMemo(() => Ts(), []);
  return { mergedProps: r.useMemo(() => M2(e3, {
    className: a,
    onClick: () => {
      t && t({ msg: "toggle_chat" });
    },
...
function _t2(e3, t, n = {}) {
  ...
  return r.useEffect(() => {
    ...
    if (((o = n.userInfo) == null ? void 0 : o.identity) === void 0)
      return;
    (async () => {
      _2.debug("fetching token");
      const u = new URLSearchParams({ ...n.userInfo, roomName: t }), i2 = await fetch(`${e3}?${u.toString()}`);
      if (!i2.ok) {
        _2.error(
  ...
  }, [e3, t, JSON.stringify(n)]), a;
}
function Jt2(e3) {
  var c, o;
  const t = Ws(e3), { className: n, mediaMutedObserver: a } = r.useMemo(
    () => gs(t),
    [N(t)]
  );
  return { isMuted: b(
...
function xt2({
  ...
  var P;
  const u = Io(), i2 = (P = u == null ? void 0 : u.localParticipant) == null ? void 0 : P.getTrackPublication(e3), d = r.useRef(false), { toggle: f, className: l, pendingObserver: p, enabledObserver: S } = r.useMemo(
    () => u ? ps(e3, u, a, s, c) : hs(),
    [u, e3, JSON.stringify(a), s]
  ), g = b(p, false), m = b(S, n ?? !!(i2 != null && i2.isEnabled));
  r.useEffect(() => {
    t == null || t(m, d.current), d.current = false;
  }, [m, t]), r.useEffect(() => {
    n !== void 0 && (_2.debug("forcing initial toggle state", e3, n), f(n));
  }, []);
  const y = r.useMemo(() => M2(o, { className: l }), [o, l]), h = r.useCallback(
    (M3) => {
      var I2;
      d.current = true, f().catch(() => d.current = false), (I2 = o.onClick) == null || I2.call(o, M3);
    },
    [o, f]
  );
  return {
...
function Wt2(e3 = [
  ...
  const n = zs(t.room), [a, s] = r.useState([]), [c, o] = r.useState([]), u = r.useMemo(() => e3.map((d) => Gi(d) ? d.source : d), [JSON.stringify(e3)]);
  return r.useEffect(() => {
    const d = As(n, u, {
      additionalRoomEvents: t.updateOnlyOn,
      onlySubscribed: t.onlySubscribed
    }).subscribe(({ trackReferences: f, participants: l }) => {
      _2.debug("setting track bundles", f, l), s(f), o(l);
    });
    return () => d.unsubscribe();
  }, [
    n,
    ...
    if (Qo(e3)) {
      const d = st2(e3, c), f = Array.from(a);
      return c.forEach((l) => {
...
function at2(e3) {
  const [t, n] = r.useState(Bt(e3)), { trackObserver: a } = r.useMemo(() => es(e3), [e3.participant.sid ?? e3.participant.identity, e3.source]);
  return r.useEffect(() => {
...
function Gt2(e3, t) {
  const n = Vs(t);
  return at2({ name: e3, participant: n });
}
function Qt2(e3) {
  const t = Hs(), n = O2(t), a = r.useMemo(
...
function $t2(e3 = {}) {
  const [t, n] = r.useState(
    Rs(e3.defaults, e3.preventLoad ?? false)
  ), a = r.useCallback((i2) => {
...
function Ht2(e3, t = {}) {
  const n = Vs(e3), a = zs(t.room), s = r.useMemo(() => os(a, n), [a, n]);
  return b(
    s,
    n.isLocal ? n.isE2EEEnabled : !!(n != null && n.isEncrypted)
  );
}
function jt2(e3, t = { fftSize: 32, smoothingTimeConstant: 0 }) {
  const n = W(e3) ? e3.publication.track : e3, [a, s] = r.useState(0);
  return r.useEffect(() => {
    if (!n || !n.mediaStream)
      return;
...
function Xt2(e3, t = {}) {
  var o;
  const n = e3 instanceof Track ? e3 : (o = e3 == null ? void 0 : e3.publication) == null ? void 0 : o.track, a = { ...ct2, ...t }, [s, c] = r.useState(
  ...
  return r.useEffect(() => {
    ...
    const { analyser: u, cleanup: i2 } = createAudioAnalyser(n, a.analyserOptions), d = u.frequencyBinCount, f = new Float32Array(d), p = setInterval(() => {
      ...
      const g = rt2(S), m = Math.ceil(g.length / a.bands), y = [];
      for (let h = 0; h < a.bands; h++) {
        const P = g.slice(h * m, (h + 1) * m).reduce((M3, I2) => M3 += I2, 0);
        y.push(P / m);
      }
      c(y);
    }, a.updateInterval);
...
function Yt(e3, t = {}) {
  var f;
  const n = e3 instanceof Track ? e3 : (f = e3 == null ? void 0 : e3.publication) == null ? void 0 : f.track, a = { ...ot2, ...t }, s = r.useRef(new Float32Array()), c = r.useRef(performance.now()), o = r.useRef(0), [u, i2] = r.useState([]), d = r.useCallback((l) => {
    i2(
      Array.from(
        ut2(l, a.barCount).map((p) => Math.sqrt(p) * a.volMultiplier)
  ...
  return r.useEffect(() => {
    ...
    const { analyser: l, cleanup: p } = createAudioAnalyser(n, {
      fftSize: q3(a.barCount)
    }), S = q3(a.barCount), g = new Float32Array(S), m = () => {
...
function ut2(e3, t) {
  const n = Math.floor(e3.length / t), a = new Float32Array(t);
  for (let s = 0; s < t; s++) {
    const c = n * s;
    let o = 0;
    for (let u = 0; u < n; u++)
...
function _4(e3, t) {
  const n = Hs(), a = _o(), s = t ? n.getParticipantByIdentity(t) : a, c = r.useMemo(
    () => s ? ks(s, { sources: e3 }) : void 0,
...
function dt2(e3) {
  ...
  const t = r.useMemo(
    () => {
      var c;
      return (c = e3 == null ? void 0 : e3.publication) != null && c.track ? _s(e3 == null ? void 0 : e3.publication.track) : void 0;
    },
    [(n = e3 == null ? void 0 : e3.publication) == null ? void 0 : n.track]
  );
  return b(t, {
    timestamp: Date.now(),
    rtpTimestamp: (s = (a = e3 == null ? void 0 : e3.publication) == null ? void 0 : a.track) == null ? void 0 : s.rtpTimestamp
  });
}
var lt2 = {
  bufferSize: 100
...
function ft2(e3, t) {
  const n = { ...lt2, ...t }, [a, s] = r.useState([]), c = dt2(e3), o = (u) => {
    var i2;
  ...
  return r.useEffect(() => {
    if (!(e3 != null && e3.publication))
      return;
    const u = Ls(e3.publication).subscribe((i2) => {
      o(...i2);
    });
    return () => {
      u.unsubscribe();
    };
  }, [e3 && N(e3), o]), { segments: a };
}
function pt2(e3 = {}) {
  const t = _o(), n = e3.participant ?? t, a = r.useMemo(
...
function Zt2(e3, t = {}) {
  const n = Vs(t.participant), [a, s] = r.useState(n.attributes[e3]);
  return r.useEffect(() => {
    if (!n)
      return;
    const c = ds(n).subscribe((o) => {
...
function Kt2() {
  ...
  ), c = a.find((l) => l.source === Track.Source.Microphone) ?? s.find((l) => l.source === Track.Source.Microphone), o = a.find((l) => l.source === Track.Source.Camera) ?? s.find((l) => l.source === Track.Source.Camera), { segments: u } = ft2(c), i2 = O2(), { attributes: d } = pt2({ participant: t }), f = r.useMemo(() => i2 === ConnectionState.Disconnected ? "disconnected" : i2 === ConnectionState.Connecting || !t || !(d != null && d[J3]) ? "connecting" : d[J3], [d, t, i2]);
  return {
    agent: t,
    state: f,
    audioTrack: c,
...
function en2(e3) {
  const t = zs(e3), n = O2(t), a = r.useMemo(() => ss(t), [t, n]);
  return b(a, t.isRecording);
}
function tn2(e3) {
  const t = Hs(), a = O2(t) === ConnectionState.Disconnected, s = r.useMemo(() => Ds(t, e3), [t, e3]);
...
var pt3 = (t) => e.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none", ...t }, e.createElement(
  "path",
  {
    fill: "currentcolor",
    fillRule: "evenodd",
...
var Me2 = (t) => e.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 20, height: 16, fill: "none", ...t }, e.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var Ct3 = (t) => e.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none", ...t }, e.createElement("g", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 }, e.createElement("path", { d: "M13.25 7H9m0 0V2.75M9 7l5.25-5.25M2.75 9H7m0 0v4.25M7 9l-5.25 5.25" })));
var It3 = e.forwardRef(
  function({ trackRef: n, ...a }, r2) {
    const c = Un(), { mergedProps: s, inFocus: o } = kt2({
      trackRef: n ?? c,
      props: a
    });
    return e.createElement(Nn.Consumer, null, (l) => l !== void 0 && e.createElement("button", { ref: r2, ...s }, a.children ? a.children : o ? e.createElement(Ct3, null) : e.createElement(Et2, null)));
  }
);
var ua = e.forwardRef(
  function({
    ...
    const f = Io(), w = e.useCallback(
      (E) => {
        f && f.emit(RoomEvent.MediaDevicesError, E), u == null || u(E);
      },
      [f, u]
    ), { devices: p, activeDeviceId: m, setActiveMediaDevice: v, className: b2 } = wt2({
      kind: n,
      room: f,
      track: l,
      requestPermissions: i2,
    ...
    const C = async (E) => {
      try {
        ...
        if (k2 instanceof Error)
          s == null || s(k2);
        else
          throw k2;
      }
    }, T2 = e.useMemo(
      () => B2(d, { className: b2 }, { className: "lk-list" }),
      [b2, d]
    ), A3 = !!p.find((E) => E.label.toLowerCase().startsWith("default"));
    function h(E, k2, I2) {
      return E === k2 || !A3 && I2 === 0 && k2 === "default";
    }
    return e.createElement("ul", { ref: g, ...T2 }, p.map((E, k2) => e.createElement(
      "li",
      {
        key: E.deviceId,
        id: E.deviceId,
        "data-lk-active": h(E.deviceId, m, k2),
        "aria-selected": h(E.deviceId, m, k2),
        role: "option"
      },
...
var da = e.forwardRef(
  function({ label: n = "Allow Audio", ...a }, r2) {
    const c = Hs(), { mergedProps: s } = Bt2({ room: c, props: a });
    return e.createElement("button", { ref: r2, ...s }, n);
  }
);
var ma = e.forwardRef(
  function({ label: n, ...a }, r2) {
    const c = Hs(), { mergedProps: s, canPlayAudio: o } = Bt2({ room: c, props: a }), { mergedProps: l, canPlayVideo: i2 } = zt2({ room: c, props: s }), { style: u, ...d } = l;
    return u.display = o && i2 ? "none" : "block", e.createElement("button", { ref: r2, style: u, ...d }, n ?? `Start ${o ? "Video" : "Audio"}`);
  }
);
function ye2(t, n) {
  switch (t) {
    case Track.Source.Microphone:
      return n ? e.createElement(kt3, null) : e.createElement(wt3, null);
    case Track.Source.Camera:
      return n ? e.createElement(vt3, null) : e.createElement(gt3, null);
    case Track.Source.ScreenShare:
      return n ? e.createElement(St, null) : e.createElement(Me2, null);
    default:
      return;
  }
}
function xt3(t) {
  switch (t) {
    case ConnectionQuality.Excellent:
      return e.createElement(Rt3, null);
    case ConnectionQuality.Good:
      return e.createElement(Mt3, null);
    case ConnectionQuality.Poor:
      return e.createElement(yt3, null);
    default:
      return e.createElement(bt2, null);
  }
}
var fa = e.forwardRef(function({ showIcon: n, ...a }, r2) {
  const { buttonProps: c, enabled: s } = xt2(a), [o, l] = e.useState(false);
  return e.useEffect(() => {
    l(true);
  }, []), o && e.createElement("button", { ref: r2, ...c }, (n ?? true) && ye2(a.source, s), a.children);
});
var be2 = e.forwardRef(function(n, a) {
  const { className: r2, quality: c } = Mt2(n), s = e.useMemo(() => ({ ...B2(n, { className: r2 }), "data-lk-quality": c }), [c, n, r2]);
  return e.createElement("div", { ref: a, ...s }, n.children ?? xt3(c));
});
var K = e.forwardRef(
  function({ participant: n, ...a }, r2) {
    const c = Vs(n), { className: s, infoObserver: o } = e.useMemo(() => ys(c), [c]), { identity: l, name: i2 } = b(o, {
      name: c.name,
      identity: c.identity,
      metadata: c.metadata
    }), u = e.useMemo(() => B2(a, { className: s, "data-lk-participant-name": i2 }), [a, s, i2]);
    return e.createElement("span", { ref: r2, ...u }, i2 !== "" ? i2 : l, a.children);
  }
);
var Se2 = e.forwardRef(
  function({ trackRef: n, show: a = "always", ...r2 }, c) {
    const { className: s, isMuted: o } = Jt2(n), l = a === "always" || a === "muted" && o || a === "unmuted" && !o, i2 = e.useMemo(
      () => B2(r2, {
        className: s
      }),
      [s, r2]
    );
    return l ? e.createElement("div", { ref: c, ...i2, "data-lk-muted": o }, r2.children ?? ye2(n.source, !o)) : null;
  }
);
var Pt3 = (t) => e.createElement(
  "svg",
  {
    width: 320,
    height: 320,
...
function Ce2(t, n = {}) {
  const [a, r2] = e.useState(Bt(t)), [c, s] = e.useState(a == null ? void 0 : a.isMuted), [o, l] = e.useState(a == null ? void 0 : a.isSubscribed), [i2, u] = e.useState(a == null ? void 0 : a.track), [d, g] = e.useState("landscape"), f = e.useRef(), { className: w, trackObserver: p } = e.useMemo(() => es(t), [
    t.participant.sid ?? t.participant.identity,
    t.source,
    W(t) && t.publication.trackSid
  ]);
  return e.useEffect(() => {
    const m = p.subscribe((v) => {
      _2.debug("update track", v), r2(v), s(v == null ? void 0 : v.isMuted), l(v == null ? void 0 : v.isSubscribed), u(v == null ? void 0 : v.track);
    });
    return () => m == null ? void 0 : m.unsubscribe();
  }, [p]), e.useEffect(() => {
    var m, v;
    return i2 && (f.current && i2.detach(f.current), (m = n.element) != null && m.current && !(t.participant.isLocal && (i2 == null ? void 0 : i2.kind) === "audio") && i2.attach(n.element.current)), f.current = (v = n.element) == null ? void 0 : v.current, () => {
...
function Tt3() {
  if (ue2) return Y2;
  ue2 = 1;
  var t = "Expected a function", n = NaN, a = "[object Symbol]", r2 = /^\s+|\s+$/g, c = /^[-+]0x[0-9a-f]+$/i, s = /^0b[01]+$/i, o = /^0o[0-7]+$/i, l = parseInt, i2 = typeof Do == "object" && Do && Do.Object === Object && Do, u = typeof self == "object" && self && self.Object === Object && self, d = i2 || u || Function("return this")(), g = Object.prototype, f = g.toString, w = Math.max, p = Math.min, m = function() {
    return d.Date.now();
  };
  function v(h, E, k2) {
    var I2, V2, O4, N2, M3, P, F2 = 0, re2 = false, Z2 = false, D3 = true;
    if (typeof h != "function")
      throw new TypeError(t);
    E = A3(E) || 0, b2(k2) && (re2 = !!k2.leading, Z2 = "maxWait" in k2, O4 = Z2 ? w(A3(k2.maxWait) || 0, E) : O4, D3 = "trailing" in k2 ? !!k2.trailing : D3);
    function U3(R) {
      var x = I2, H4 = V2;
      return I2 = V2 = void 0, F2 = R, N2 = h.apply(H4, x), N2;
    }
    function Pe2(R) {
      return F2 = R, M3 = setTimeout(W3, E), re2 ? U3(R) : N2;
    }
    function Te2(R) {
      var x = R - P, H4 = R - F2, se2 = E - x;
      return Z2 ? p(se2, O4 - H4) : se2;
    }
    function ce2(R) {
      var x = R - P, H4 = R - F2;
      return P === void 0 || x >= E || x < 0 || Z2 && H4 >= O4;
    }
    function W3() {
      var R = m();
      if (ce2(R))
        return le2(R);
      M3 = setTimeout(W3, Te2(R));
    }
    function le2(R) {
      return M3 = void 0, D3 && I2 ? U3(R) : (I2 = V2 = void 0, N2);
    }
    function Ae2() {
      M3 !== void 0 && clearTimeout(M3), F2 = 0, I2 = P = V2 = M3 = void 0;
    }
    function Ne2() {
      return M3 === void 0 ? N2 : le2(m());
    }
    function G3() {
      var R = m(), x = ce2(R);
      if (I2 = arguments, V2 = this, P = R, x) {
        if (M3 === void 0)
          return Pe2(P);
        if (Z2)
          return M3 = setTimeout(W3, E), U3(P);
      }
      return M3 === void 0 && (M3 = setTimeout(W3, E)), N2;
    }
    return G3.cancel = Ae2, G3.flush = Ne2, G3;
  }
  function b2(h) {
    var E = typeof h;
  ...
  function A3(h) {
    ...
    h = h.replace(r2, "");
    var k2 = s.test(h);
    return k2 || o.test(h) ? l(h.slice(2), k2 ? 2 : 8) : c.test(h) ? n : +h;
  }
  return Y2 = v, Y2;
}
var At3 = Tt3();
...
function Lt3(t, n = 500, a) {
  const r2 = (0, import_react.useRef)();
  Nt3(() => {
    r2.current && r2.current.cancel();
  });
  const c = (0, import_react.useMemo)(() => {
    const s = de2(t, n, a), o = (...l) => s(...l);
    return o.cancel = () => {
      s.cancel();
    }, o.isPending = () => !!r2.current, o.flush = () => s.flush(), o;
  }, [t, n, a]);
  return (0, import_react.useEffect)(() => {
    r2.current = de2(t, n, a);
  }, [t, n, a]), c;
}
function zt3(t, n, a) {
  const r2 = (u, d) => u === d, c = t instanceof Function ? t() : t, [s, o] = (0, import_react.useState)(c), l = (0, import_react.useRef)(c), i2 = Lt3(
    o,
    n,
    a
  );
  return r2(l.current, c) || (i2(c), l.current = c), [s, i2];
}
function Vt3({
  threshold: t = 0,
  root: n = null,
  ...
  var o;
  const [l, i2] = (0, import_react.useState)(null), [u, d] = (0, import_react.useState)(() => ({
    isIntersecting: c,
    entry: void 0
  })), g = (0, import_react.useRef)();
  g.current = s;
  const f = ((o = u.entry) == null ? void 0 : o.isIntersecting) && r2;
  (0, import_react.useEffect)(() => {
    ...
    const m = new IntersectionObserver(
      (v) => {
        ...
        v.forEach((C) => {
          const T2 = C.isIntersecting && b2.some((A3) => C.intersectionRatio >= A3);
  ...
  (0, import_react.useEffect)(() => {
    var m;
    !l && ((m = u.entry) != null && m.target) && !r2 && !f && w.current !== u.entry.target && (w.current = u.entry.target, d({ isIntersecting: c, entry: void 0 }));
  }, [l, u.entry, r2, f, c]);
  const p = [
    i2,
    !!u.isIntersecting,
...
var Ft3 = e.forwardRef(
  function({
    ...
    const i2 = Ws(c), u = e.useRef(null);
    e.useImperativeHandle(l, () => u.current);
    const d = Vt3({ root: u.current }), [g] = zt3(d, 3e3);
    e.useEffect(() => {
      s && i2.publication instanceof RemoteTrackPublication && (g == null ? void 0 : g.isIntersecting) === false && (d == null ? void 0 : d.isIntersecting) === false && i2.publication.setSubscribed(false);
    }, [g, i2, s]), e.useEffect(() => {
      s && i2.publication instanceof RemoteTrackPublication && (d == null ? void 0 : d.isIntersecting) === true && i2.publication.setSubscribed(true);
    }, [d, i2, s]);
    const {
      elementProps: f,
      publication: w,
    ...
    const m = (v) => {
      a == null || a(v), n == null || n({ participant: i2 == null ? void 0 : i2.participant, track: w });
    };
    return e.createElement("video", { ref: u, ...f, muted: true, onClick: m });
  }
);
var ne = e.forwardRef(
  function({ trackRef: n, onSubscriptionStatusChanged: a, volume: r2, ...c }, s) {
    const o = Ws(n), l = e.useRef(null);
    ...
    return e.useEffect(() => {
      ...
      d === void 0 || r2 === void 0 || (d instanceof RemoteAudioTrack ? d.setVolume(r2) : _2.warn("Volume can only be set on remote audio tracks."));
    }, [r2, d]), e.useEffect(() => {
    ...
    }, [c.muted, g, d]), e.createElement("audio", { ref: l, ...i2 });
  }
);
function Zt3(t) {
  const n = !!_o();
...
var Bt3 = e.forwardRef(
  function({
    ...
    var w, p;
    const l = Ws(n), { elementProps: i2 } = Dt2({
      htmlProps: s,
      disableSpeakingIndicator: c,
      onParticipantClick: r2,
      trackRef: l
    }), u = Ht2(l.participant), d = Lo(), g = (w = Ys()) == null ? void 0 : w.autoSubscription, f = e.useCallback(
      (m) => {
        l.source && !m && d && d.pin.dispatch && No(l, d.pin.state) && d.pin.dispatch({ msg: "clear_pin" });
      },
      [l, d]
    );
    return e.createElement("div", { ref: o, style: { position: "relative" }, ...i2 }, e.createElement(Ht3, { trackRef: l }, e.createElement(Zt3, { participant: l.participant }, a ?? e.createElement(e.Fragment, null, W(l) && (((p = l.publication) == null ? void 0 : p.kind) === "video" || l.source === Track.Source.Camera || l.source === Track.Source.ScreenShare) ? e.createElement(
      Ft3,
      {
        trackRef: l,
    ...
    ), e.createElement("div", { className: "lk-participant-placeholder" }, e.createElement(Pt3, null)), e.createElement("div", { className: "lk-participant-metadata" }, e.createElement("div", { className: "lk-participant-metadata-item" }, l.source === Track.Source.Camera ? e.createElement(e.Fragment, null, u && e.createElement(pt3, { style: { marginRight: "0.25rem" } }), e.createElement(
      Se2,
      {
        trackRef: {
    ...
    ), e.createElement(K, null)) : e.createElement(e.Fragment, null, e.createElement(Me2, { style: { marginRight: "0.25rem" } }), e.createElement(K, null, "'s screen"))), e.createElement(be2, { className: "lk-participant-metadata-item" }))), e.createElement(It3, { trackRef: l }))));
  }
);
function ha(t) {
  const n = B2(t, { className: "lk-focus-layout" });
  return e.createElement("div", { ...n }, t.children);
}
function ga({ trackRef: t, ...n }) {
  return e.createElement(Bt3, { trackRef: t, ...n });
}
function Ie2({ tracks: t, ...n }) {
...
function jt3({
  ...
  return e.useEffect(() => {
    let l;
    return c && (l = Is(c.current, 2e3).subscribe(
      o
    )), () => {
      l && l.unsubscribe();
    };
  }, [c]), e.createElement("div", { className: "lk-pagination-control", "data-lk-user-interaction": s }, e.createElement("button", { className: "lk-button", onClick: a }, e.createElement(ie2, null)), e.createElement("span", { className: "lk-pagination-count" }, `${r2} of ${t}`), e.createElement("button", { className: "lk-button", onClick: n }, e.createElement(ie2, null)));
}
var _t3 = e.forwardRef(
  function({ totalPageCount: n, currentPage: a }, r2) {
...
function va({ tracks: t, ...n }) {
  const a = e.createRef(), r2 = e.useMemo(
    () => B2(n, { className: "lk-grid-layout" }),
    [n]
  ), { layout: c } = Et(a, t.length), s = Ct2(c.maxTiles, t);
  return Ut2(a, {
    onLeftSwipe: s.nextPage,
    onRightSwipe: s.prevPage
  }), e.createElement("div", { ref: a, "data-lk-pagination": s.totalPageCount > 1, ...r2 }, e.createElement(Ie2, { tracks: s.tracks }, n.children), t.length > c.maxTiles && e.createElement(e.Fragment, null, e.createElement(
    _t3,
    {
      totalPageCount: s.totalPageCount,
      currentPage: s.currentPage
    }
  ), e.createElement(jt3, { pagesContainer: a, ...s })));
}
var Ot3 = 130;
var Wt3 = 140;
var me2 = 1;
...
function Ea({ tracks: t, orientation: n, ...a }) {
  const r2 = e.useRef(null), [c, s] = e.useState(0), { width: o, height: l } = Xe2(r2), i2 = n || (l >= o ? "vertical" : "horizontal"), u = i2 === "vertical" ? Math.max(o * qt3, Ot3) : Math.max(l * xe, Wt3), d = Fo(), g = Math.max(i2 === "vertical" ? (l - d) / u : (o - d) / u, me2);
  let f = Math.round(g);
  Math.abs(g - c) < 0.5 ? f = Math.round(c) : c !== g && s(g);
  const w = et2(t, f);
  return e.useLayoutEffect(() => {
    r2.current && (r2.current.dataset.lkOrientation = i2, r2.current.style.setProperty("--lk-max-visible-tiles", f.toString()));
  }, [f, i2]), e.createElement("aside", { key: i2, className: "lk-carousel", ref: r2, ...a }, e.createElement(Ie2, { tracks: w }, a.children));
}
function pa({
  value: t,
  onPinChange: n,
  ...
  }, [a, c.widget.state]), e.createElement(Nn.Provider, { value: c }, r2);
}
var wa = e.forwardRef(
  function({ trackRef: n, ...a }, r2) {
    const d = Ws(n), g = Xt2(d, { bands: 7, loPass: 300 });
...
function ka({ participants: t, ...n }) {
  return e.createElement(e.Fragment, null, t.map((a) => e.createElement(jn.Provider, { value: a, key: a.identity }, G2(n.children))));
}
function Ra({ volume: t, muted: n }) {
  ...
  return e.createElement("div", { style: { display: "none" } }, a.map((r2) => e.createElement(
    ne,
    {
      key: N(r2),
      trackRef: r2,
...
var Ma = e.forwardRef(function({ childrenPosition: n = "before", children: a, ...r2 }, c) {
  const { name: s } = Ft2();
  return e.createElement("span", { ref: c, ...r2 }, n === "before" && a, s, n === "after" && a);
});
function $t3(t) {
  const n = e.useMemo(() => B2(t, { className: "lk-toast" }), [t]);
  return e.createElement("div", { ...n }, t.children);
}
var Dt3 = (t) => {
  const n = [];
...
var Ut3 = (t, n, a) => {
  const [r2, c] = (0, import_react.useState)(0), [s, o] = (0, import_react.useState)([[]]);
  (0, import_react.useEffect)(() => {
    if (t === "thinking")
      o(fe(n));
      ...
      const i2 = [...Dt3(n)];
      o(i2);
    } else o(t === "listening" ? fe(n) : t === void 0 ? [new Array(n).fill(0).map((i2, u) => u)] : [[]]);
    c(0);
  }, [t, n]);
  ...
  }, [a, n, t, s.length]), s[r2 % s.length];
};
var Gt3 = /* @__PURE__ */ new Map([
  ["connecting", 2e3],
  ["initializing", 2e3],
  ["listening", 500],
  ["thinking", 150]
...
var Xt3 = e.forwardRef(
  function({ state: n, options: a, barCount: r2 = 15, trackRef: c, children: s, ...o }, l) {
    const i2 = B2(o, { className: "lk-audio-bar-visualizer" });
    let u = Un();
    c && (u = c);
    const d = Xt2(u, {
      bands: r2,
      loPass: 100,
      hiPass: 200
    }), g = (a == null ? void 0 : a.minHeight) ?? 20, f = (a == null ? void 0 : a.maxHeight) ?? 100, w = Ut3(
      n,
      r2,
      Qt3(n, r2) ?? 100
    );
    return e.createElement("div", { ref: l, ...i2, "data-lk-va-state": n }, d.map(
      (p, m) => s ? G2(s, {
...
var ya = e.forwardRef(
  function({
    ...
    const l = Ws(c), { elementProps: i2 } = Dt2({
      trackRef: l,
      htmlProps: s,
      disableSpeakingIndicator: a,
      onParticipantClick: r2
    });
    return e.createElement("div", { ref: o, style: { position: "relative", minHeight: "160px" }, ...i2 }, e.createElement(Fn.Provider, { value: l }, n ?? e.createElement(e.Fragment, null, W(l) && e.createElement(ne, { trackRef: l }), e.createElement(Xt3, { barCount: 7, options: { minHeight: 8 } }), e.createElement("div", { className: "lk-participant-metadata" }, e.createElement("div", { className: "lk-participant-metadata-item" }, e.createElement(Se2, { trackRef: l }), e.createElement(K, null)), e.createElement(be2, { className: "lk-participant-metadata-item" })))));
  }
);
function ba(t) {
  const [n, a] = e.useState(void 0), r2 = O2(t.room);
  return e.useEffect(() => {
    switch (r2) {
  ...
  }, [r2]), n ? e.createElement($t3, { className: "lk-toast-connection-state" }, n) : e.createElement(e.Fragment, null);
}
var Sa = e.forwardRef(
  function({ entry: n, hideName: a = false, hideTimestamp: r2 = false, messageFormatter: c, ...s }, o) {
    var f, w, p, m;
    const l = e.useMemo(() => c ? c(n.message) : n.message, [n.message, c]), i2 = !!n.editTimestamp, u = new Date(n.timestamp), d = typeof navigator < "u" ? navigator.language : "en-US", g = ((f = n.from) == null ? void 0 : f.name) ?? ((w = n.from) == null ? void 0 : w.identity);
    return e.createElement(
      "li",
      {
        ref: o,
      ...
      (!r2 || !a || i2) && e.createElement("span", { className: "lk-meta-data" }, !a && e.createElement("strong", { className: "lk-participant-name" }, g), (!r2 || i2) && e.createElement("span", { className: "lk-timestamp" }, i2 && "edited ", u.toLocaleTimeString(d, { timeStyle: "short" }))),
...
function Ca(t) {
  return Vo(t, Bo()).map((n, a) => {
    if (typeof n == "string")
      return n;
    {
      const r2 = n.content.toString(), c = n.type === "url" ? /^http(s?):\/\//.test(r2) ? r2 : `https://${r2}` : `mailto:${r2}`;
      return e.createElement("a", { className: "lk-chat-link", key: a, href: c, target: "_blank", rel: "noreferrer" }, r2);
    }
  });
}
...
function ee2({
  ...
  const p = e2.useRef(null), m = e2.useRef(null), u = e2.useMemo(() => ({ messageDecoder: d, messageEncoder: l, channelTopic: n }), [d, l, n]), { chatMessages: s, send: I2, isSending: t } = Qt2(u), h = Lo(), r2 = e2.useRef(0);
  async function v(c) {
  ...
  return e2.useEffect(() => {
    ...
    if (!h || s.length === 0)
      return;
    if ((i2 = h.widget.state) != null && i2.showChat && s.length > 0 && r2.current !== ((g = s[s.length - 1]) == null ? void 0 : g.timestamp)) {
      r2.current = (a = s[s.length - 1]) == null ? void 0 : a.timestamp;
      return;
    }
    const c = s.filter(
      (A3) => !r2.current || A3.timestamp > r2.current
    ).length, { widget: f } = h;
    ...
    const g = f >= 1 && i2[f - 1].from === c.from, a = f >= 1 && c.timestamp - i2[f - 1].timestamp < 6e4;
...
function O3({
  ...
  const [m, u] = e2.useState(false), [s, I2] = e2.useState([]), [t, h] = e2.useState(true), [r2, v] = e2.useState(E), c = (a, C) => {
    _2.debug("handle device change"), u(false), l == null || l(a, C);
  }, f = e2.useRef(null), i2 = e2.useRef(null);
  e2.useLayoutEffect(() => {
    m && v(true);
  }, [m]), e2.useLayoutEffect(() => {
    let a;
    return f.current && i2.current && (s || t) && (a = jo(f.current, i2.current, (C, S) => {
      i2.current && Object.assign(i2.current.style, { left: `${C}px`, top: `${S}px` });
    })), h(false), () => {
      a == null || a();
    };
  }, [f, i2, s, t]);
  const g = e2.useCallback(
    (a) => {
      i2.current && a.target !== f.current && m && Wo(i2.current, a) && u(false);
    },
    [m, i2, f]
  );
...
function Ke3(o, d) {
  ...
  }, [JSON.stringify(o, J2), d, E]), l;
}
function Ze3(o, d, l) {
  const [n, E] = e2.useState(null), [p, m] = e2.useState(false), u = At2({ kind: l }), [s, I2] = e2.useState(
    void 0
  ), [t, h] = e2.useState(), [r2, v] = e2.useState(d);
  e2.useEffect(() => {
    v(d);
  }, [d]);
  const c = async (g, a) => {
    try {
      ...
      S && g !== S && (i2.current = S, v(S)), h(C);
    } catch (C) {
      C instanceof Error && E(C);
    }
  }, f = async (g, a) => {
    await g.setDeviceId(a), i2.current = a;
  }, i2 = e2.useRef(r2);
  return e2.useEffect(() => {
    o && !t && !n && !p && (_2.debug("creating track", l), m(true), c(r2, l).finally(() => {
      m(false);
    }));
  }, [o, t, n, p]), e2.useEffect(() => {
    t && (o ? s != null && s.deviceId && i2.current !== (s == null ? void 0 : s.deviceId) ? (_2.debug(`switching ${l} device from`, i2.current, s.deviceId), f(t, s.deviceId)) : (_2.debug(`unmuting local ${l} track`), t.unmute()) : (_2.debug(`muting ${l} track`), t.mute().then(() => _2.debug(t.mediaStreamTrack))));
  }, [t, s, o, l]), e2.useEffect(() => () => {
    t && (_2.debug(`stopping local ${l} track`), t.stop(), t.mute());
  }, []), e2.useEffect(() => {
    I2(u == null ? void 0 : u.find((g) => g.deviceId === r2));
  }, [r2, u]), {
    selectedDevice: s,
    localTrack: t,
    deviceError: n
...
function et3({
  ...
  const {
    ...
    saveVideoInputEnabled: i2,
    saveUsername: g
  } = $t2({
    defaults: o,
    preventSave: !I2,
    preventLoad: !I2
  }), [a, C] = e2.useState(r2), [S, A3] = e2.useState(a.audioEnabled), [w, L3] = e2.useState(a.videoEnabled), [T2, $] = e2.useState(a.audioDeviceId), [k2, N2] = e2.useState(a.videoDeviceId), [V2, ae2] = e2.useState(a.username);
  e2.useEffect(() => {
    c(S);
  }, [S, c]), e2.useEffect(() => {
    i2(w);
  ...
  const D3 = Ke3(
    {
      audio: S ? { deviceId: r2.audioDeviceId } : false,
      video: w ? { deviceId: r2.videoDeviceId, processor: t } : false
    },
    n
  ), U3 = e2.useRef(null), M3 = e2.useMemo(
    () => D3 == null ? void 0 : D3.filter((b2) => b2.kind === Track.Kind.Video)[0],
    [D3]
  ), ne2 = e2.useMemo(() => {
    if (M3) {
      const { facingMode: b2 } = facingModeFromLocalTrack(M3);
      return b2;
    } else
      return "undefined";
  }, [M3]), j2 = e2.useMemo(
    () => D3 == null ? void 0 : D3.filter((b2) => b2.kind === Track.Kind.Audio)[0],
    [D3]
  );
  e2.useEffect(() => (U3.current && M3 && (M3.unmute(), M3.attach(U3.current)), () => {
    M3 == null || M3.detach();
  }), [M3]);
  const [se2, ce2] = e2.useState(), _5 = e2.useCallback(
  ...
  function re2(b2) {
    b2.preventDefault(), _5(a) ? typeof l == "function" && l(a) : _2.warn("Validation failed with: ", a);
  }
  return W2(), e2.createElement("div", { className: "lk-prejoin", ...h }, e2.createElement("div", { className: "lk-video-container" }, M3 && e2.createElement("video", { ref: U3, width: "1280", height: "720", "data-lk-facing-mode": ne2 }), (!M3 || !w) && e2.createElement("div", { className: "lk-camera-off-note" }, e2.createElement(Pt3, null))), e2.createElement("div", { className: "lk-button-group-container" }, e2.createElement("div", { className: "lk-button-group audio" }, e2.createElement(
    fa,
    {
      initialState: S,
      source: Track.Source.Microphone,
    ...
    O3,
    {
      ...
      kind: "videoinput",
      disabled: !M3,
      tracks: { videoinput: M3 },
      onActiveDeviceChange: (b2, F2) => N2(F2)
    }
    ...
    "input",
    {
      ...
      defaultValue: V2,
      placeholder: s,
      onChange: (b2) => ae2(b2.target.value),
      autoComplete: "off"
    }
  ), e2.createElement(
    "button",
...
function Ge2({ props: o }) {
  const { dispatch: d, state: l } = $s().widget, n = "lk-button lk-settings-toggle";
  return { mergedProps: e2.useMemo(() => M2(o, {
    className: n,
    onClick: () => {
...
function te({
  ...
  var $;
  const [p, m] = e2.useState(false), u = Lo();
  e2.useEffect(() => {
    var k2, N2;
  ...
  const I2 = gt2(`(max-width: ${p ? 1e3 : 760}px)`) ? "minimal" : "verbose";
  o ?? (o = I2);
  const t = { leave: true, ...d }, h = Tt2();
  ...
  const r2 = e2.useMemo(
    ...
    [o]
  ), c = qo(), [f, i2] = e2.useState(false), g = e2.useCallback(
    (k2) => {
      i2(k2);
    },
    [i2]
  ), a = B2({ className: "lk-control-bar" }, E), {
    saveAudioInputEnabled: C,
    saveVideoInputEnabled: S,
    saveAudioInputDeviceId: A3,
    saveVideoInputDeviceId: w
  } = $t2({ preventSave: !l }), L3 = e2.useCallback(
    (k2, N2) => N2 ? C(k2) : null,
    [C]
  ), T2 = e2.useCallback(
    (k2, N2) => N2 ? S(k2) : null,
  ...
  return e2.createElement("div", { ...a }, t.microphone && e2.createElement("div", { className: "lk-button-group" }, e2.createElement(
    fa,
    {
      ...
      showIcon: r2,
      onChange: L3,
      onDeviceError: (k2) => n == null ? void 0 : n({ source: Track.Source.Microphone, error: k2 })
    },
    v && "Microphone"
  ), e2.createElement("div", { className: "lk-button-group-menu" }, e2.createElement(
    O3,
    {
      kind: "audioinput",
      onActiveDeviceChange: (k2, N2) => A3(N2 ?? "default")
    }
    ...
    fa,
    {
      ...
      showIcon: r2,
      onChange: T2,
      onDeviceError: (k2) => n == null ? void 0 : n({ source: Track.Source.Camera, error: k2 })
    },
    v && "Camera"
  ), e2.createElement("div", { className: "lk-button-group-menu" }, e2.createElement(
    O3,
    {
      kind: "videoinput",
      onActiveDeviceChange: (k2, N2) => w(N2 ?? "default")
    }
    ...
    fa,
    {
      ...
      showIcon: r2,
      onChange: g,
      onDeviceError: (k2) => n == null ? void 0 : n({ source: Track.Source.ScreenShare, error: k2 })
    },
    v && (f ? "Stop screen share" : "Share screen")
  ), t.chat && e2.createElement(ra, null, r2 && e2.createElement(sa, null), v && "Chat"), t.settings && e2.createElement(Je2, null, r2 && e2.createElement(ia, null), v && "Settings"), t.leave && e2.createElement(ca, null, r2 && e2.createElement(oa, null), v && "Leave"), e2.createElement(ma, null));
}
function tt3({
  ...
  const [p, m] = e2.useState({
    ...
    _2.debug("updating widget state", i2), m(i2);
  }, t = Fs(), h = s.filter(W).filter((i2) => i2.publication.source === Track.Source.ScreenShare), r2 = (c = Rt2(t)) == null ? void 0 : c[0], v = s.filter((i2) => !$o(i2, r2));
  return e2.useEffect(() => {
    var i2, g, a, C, S, A3;
    if (h.some((w) => w.publication.isSubscribed) && u.current === null ? (_2.debug("Auto set screen share focus:", { newScreenShareTrack: h[0] }), (g = (i2 = t.pin).dispatch) == null || g.call(i2, { msg: "set_pin", trackReference: h[0] }), u.current = h[0]) : u.current && !h.some(
      (w) => {
        var L3, T2;
        return w.publication.trackSid === ((T2 = (L3 = u.current) == null ? void 0 : L3.publication) == null ? void 0 : T2.trackSid);
      }
    ) && (_2.debug("Auto clearing screen share focus."), (C = (a = t.pin).dispatch) == null || C.call(a, { msg: "clear_pin" }), u.current = null), r2 && !W(r2)) {
      const w = s.find(
        (L3) => L3.participant.identity === r2.participant.identity && L3.source === r2.source
      );
      w !== r2 && W(w) && ((A3 = (S = t.pin).dispatch) == null || A3.call(S, { msg: "set_pin", trackReference: w }));
    }
  }, [
    h.map((i2) => `${i2.publication.trackSid}_${i2.publication.isSubscribed}`).join(),
    (f = r2 == null ? void 0 : r2.publication) == null ? void 0 : f.trackSid,
    s
  ]), W2(), e2.createElement("div", { className: "lk-video-conference", ...E }, Uo() && e2.createElement(
    pa,
    {
      value: t,
      onWidgetChange: I2
    },
    e2.createElement("div", { className: "lk-video-conference-inner" }, r2 ? e2.createElement("div", { className: "lk-focus-layout-wrapper" }, e2.createElement(ha, null, e2.createElement(Ea, { tracks: v }, e2.createElement(Bt3, null)), r2 && e2.createElement(ga, { trackRef: r2 }))) : e2.createElement("div", { className: "lk-grid-layout-wrapper" }, e2.createElement(va, { tracks: s }, e2.createElement(Bt3, null))), e2.createElement(te, { controls: { chat: true, settings: !!n } })),
    e2.createElement(
      ee2,
      {
...
function at3({ ...o }) {
  const [d, l] = e2.useState({
    showChat: false,
    unreadMessages: 0
  }), n = Wt2([Track.Source.Microphone]);
  return W2(), e2.createElement(pa, { onWidgetChange: l }, e2.createElement("div", { className: "lk-audio-conference", ...o }, e2.createElement("div", { className: "lk-audio-conference-stage" }, e2.createElement(Ie2, { tracks: n }, e2.createElement(ya, null))), e2.createElement(
    te,
    {
...
function nt3({
  ...
  const E = { leave: true, microphone: true, ...o }, p = Tt2(), { microphoneTrack: m, localParticipant: u } = Ke2(), s = e2.useMemo(() => ({
    participant: u,
    source: Track.Source.Microphone,
    publication: m
  }), [u, m]);
  p ? E.microphone ?? (E.microphone = p.canPublish) : E.microphone = false;
  const I2 = B2({ className: "lk-agent-control-bar" }, n), { saveAudioInputEnabled: t, saveAudioInputDeviceId: h } = $t2({
    preventSave: !d
  }), r2 = e2.useCallback(
    (v, c) => {
      c && t(v);
  ...
  return e2.createElement("div", { ...I2 }, E.microphone && e2.createElement("div", { className: "lk-button-group" }, e2.createElement(
    ...
    e2.createElement(Xt3, { trackRef: s, barCount: 7, options: { minHeight: 5 } })
  ), e2.createElement("div", { className: "lk-button-group-menu" }, e2.createElement(
    O3,
    {
      kind: "audioinput",
...
export {
  at3 as AudioConference,
  ne as AudioTrack,
  wa as AudioVisualizer,
  Xt3 as BarVisualizer,
  gt3 as CameraDisabledIcon,
  vt3 as CameraIcon,
  ...
  be2 as ConnectionQualityIndicator,
  ...
  $t3 as Toast,
  Ie2 as TrackLoop,
  Se2 as TrackMutedIndicator,
  Fn as TrackRefContext,
  Ht3 as TrackRefContextIfNeeded,
  fa as TrackToggle,
  Ct3 as UnfocusToggleIcon,
  tt3 as VideoConference,
  Ft3 as VideoTrack,
  nt3 as VoiceAssistantControlBar,
  Ca as formatChatMessageLinks,
  W as isTrackReference,
  zo as setLogExtension,
  Ho as setLogLevel,
  vt2 as useAudioPlayback,
  Yt as useAudioWaveform,
  Qt2 as useChat,
  qt2 as useChatToggle,
  ht2 as useClearPinButton,
  Mt2 as useConnectionQualityIndicator,
  O2 as useConnectionState,
  Fs as useCreateLayoutContext,
  yt2 as useDataChannel,
  Pt2 as useDisconnectButton,
  Us as useEnsureCreateLayoutContext,
  Ns as useEnsureLayoutContext,
  Vs as useEnsureParticipant,
  zs as useEnsureRoom,
  Ws as useEnsureTrackRef,
  Ye2 as useFacingMode,
  Ys as useFeatureContext,
  kt2 as useFocusToggle,
  Et as useGridLayout,
  Ht2 as useIsEncrypted,
  U2 as useIsMuted,
  en2 as useIsRecording,
  Ze2 as useIsSpeaking,
  $s as useLayoutContext,
  q2 as useLiveKitRoom,
  Ke2 as useLocalParticipant,
  Tt2 as useLocalParticipantPermissions,
  Lo as useMaybeLayoutContext,
  _o as useMaybeParticipantContext,
  Io as useMaybeRoomContext,
  Un as useMaybeTrackRefContext,
  wt2 as useMediaDeviceSelect,
  At2 as useMediaDevices,
  Xt2 as useMultibandTrackVolume,
  Ct2 as usePagination,
  Zt2 as useParticipantAttribute,
  pt2 as useParticipantAttributes,
  Bs as useParticipantContext,
  Ot2 as useParticipantInfo,
  It2 as useParticipantPermissions,
  Dt2 as useParticipantTile,
  _4 as useParticipantTracks,
  Lt2 as useParticipants,
  $t2 as usePersistentUserChoices,
  Rt2 as usePinnedTracks,
  Ze3 as usePreviewDevice,
  Ke3 as usePreviewTracks,
  Nt2 as useRemoteParticipant,
  H3 as useRemoteParticipants,
  Hs as useRoomContext,
  Ft2 as useRoomInfo,
  Vt2 as useSortedParticipants,
  tt2 as useSpeakingParticipants,
  Bt2 as useStartAudio,
  zt2 as useStartVideo,
  Ut2 as useSwipe,
  tn2 as useTextStream,
  _t2 as useToken,
  Gt2 as useTrackByName,
  Jt2 as useTrackMutedIndicator,
  js as useTrackRefContext,
  xt2 as useTrackToggle,
  ft2 as useTrackTranscription,
  jt2 as useTrackVolume,
  Wt2 as useTracks,
  et2 as useVisualStableUpdate,
